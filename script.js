// JS to read arctic db file
var ARCTIC_URL = "http://www.festvox.org/cmu_arctic/cmuarctic.data";
//import * as cmu from './cmu_data.js';
//import { data } from './cmu_data.js';


/* Write a Javascript function that loads a text file from a URL and places the contents into an array */
...
// readTextFile("./cmuarctic.data");

$(document).ready(function(){
  


/* Write a javascript program that displays a single element of an array in a text box at a time, and does a slide transition to the next element when the space bar is pressed. */
