...
const questions_data = [
{
    ...
    "data": [
        ...
        "What is the square root:<br><br>100",
        "What is the square root:<br><br>81",
        "What is the square root:<br><br>64",
        "What is the square root:<br><br>49",
        "What is the square root:<br><br>36",
        "What is the square root:<br><br>25",
        "What is the square root:<br><br>16",
        "What is the square root:<br><br>9",
        "What is the square root:<br><br>4",
        "What is the square root:<br><br>1",
    ]
},
{
...
},
{
    ...
    "question_type": "simple",
    "data": [
        "In 1 minute:<br><br>Name as many animals as you can.",
        "In 1 minute:<br><br>Name as many countries as you can.",
        "In 1 minute:<br><br>Name as many U.S. states as you can.",
        "In 1 minute:<br><br>Name as many countries in Europe as you can.",
        "In 1 minute:<br><br>Name as many countries in Africa as you can.",
        "In 1 minute:<br><br>Name as many countries in North America as you can.",
        "In 1 minute:<br><br>Name as many countries in South America as you can.",
        "In 1 minute:<br><br>Name as many countries in Asia as you can.",
        "In 1 minute:<br><br>Name as many countries in Antarctica as you can.",
        "In 1 minute:<br><br>Name as many countries in Australia as you can.",
        "In 1 minute, name as many as you can:<br><br>Cities",
        "In 1 minute, name as many as you can:<br><br>Senators & Congresspeople",
        "In 1 minute, name as many as you can:<br><br>Supreme Court Justices",
        "In 1 minute, name as many as you can:<br><br>Planets & Moons",
        "In 1 minute, name as many as you can:<br><br>Rock bands",
        "In 1 minute, name as many as you can:<br><br>Colors",
        "In 1 minute, name as many as you can:<br><br>Tools",
        "In 1 minute, name as many as you can:<br><br>Beers",
        "In 1 minute, name as many as you can:<br><br>Geometric shapes",
        "In 1 minute, name as many as you can:<br><br>Oceans & Rivers",
        "In 1 minute, name as many as you can:<br><br>Fruits & Vegetables",
        "In 1 minute, name as many as you can:<br><br>Kitchen appliances",
        "In 1 minute, name as many as you can:<br><br>Household appliances",
        "In 1 minute, name as many as you can:<br><br>Diving gear",
        "In 1 minute, name as many as you can:<br><br>Cuts of beef",
        "In 1 minute, name as many as you can:<br><br>Types of seafood",
        "In 1 minute, name as many as you can:<br><br>Types of wine",
        "In 1 minute, name as many as you can:<br><br>Heads of state",
    ]
},
{
